...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String DOB = getIntent().getExtras().getString("date");
        int date=Integer.parseInt(DOB);
        String City = getIntent().getExtras().getString("city");

        Friends f8=new Friends(9,Name,date,City);
        setListAdapter(f8);
    }

    private void setListAdapter(Friends f8) {
        ...
        friendsList.addAll(Arrays.asList(new Friends[]{f8,f1,f2,f3,f4,f5,f6,f7,f0,}));
